    ...
    <q-drawer class="left-navigation text-white"
      ...
      <div style="height: calc(100% - 117px);padding:10px">
        <q-toolbar>
          ...
          <q-toolbar-title>{{this.u}}</q-toolbar-title>
        </q-toolbar>
        <hr/>
        <q-scroll-area style="height:100%;">
          <q-list padding>
            ...
            <q-item active-class="tab-active" to="/products" class="q-ma-sm navigation-item" clickable
                    v-ripple>
              <q-item-section avatar>
                <q-icon name="star"/>
              </q-item-section>
        ...
        <!--    <q-item active-class="tab-active" to="/sales_invoices" class="q-ma-sm navigation-item" clickable v-ripple>
         ...
         <!--   <q-item active-class="tab-active" to="/transactions" class="q-ma-sm navigation-item" clickable v-ripple>
            ...
            <q-item active-class="tab-active" to="/empleados" class="q-ma-sm navigation-item" clickable
                    v-ripple>
              <q-item-section avatar>
                <q-icon name="list"/>
              </q-item-section>
            ...
            <q-item active-class="tab-active" to="/sucursales" class="q-ma-sm navigation-item" clickable v-ripple>
              <q-item-section avatar>
